...
{
    public class DynamicConfigurationReader : IDisposable
    {
        ...
        public DynamicConfigurationReader(string applicationName, string connectionString, int refreshIntervalInMs)
        {
